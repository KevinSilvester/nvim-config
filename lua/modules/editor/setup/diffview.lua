...
-- stylua: ignore
M.keys = {
   { '<leader>gdh', m.cmd('DiffviewFileHistory %'), desc = '[diffview] Current File History' },
   { '<leader>gdt', m.cmd('DiffviewToggle'),        desc = '[diffview] Toggle DiffView' },
   { '<leader>gdr', m.cmd('DiffviewRefresh'),       desc = '[diffview] Refresh DiffView' },
}
